...
/* BINDTOOL_HEADER_FILE_HASH(f5acb695f56434d8ea26248e889bea45) */
/***********************************************************************************/
...
void bind_find_local_max(py::module &m) {
  ...
  py::class_<find_local_max, gr::sync_block, gr::block, gr::basic_block,
             std::shared_ptr<find_local_max>>(m, "find_local_max",
                                              D(find_local_max))

      .def(py::init(&find_local_max::make), py::arg("num_max_vals"),
           py::arg("vector_len"), py::arg("x_min"), py::arg("x_max"),
